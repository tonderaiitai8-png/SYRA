...
export interface CartItem {
  ...
  sideItem?: string;
  drinkItem?: string;
  sideUpgradeCost?: number; // e.g., +0.50 for peri chips, +1.00 for cheesy
  
  // Customizations
  salad?: string[]; // ['lettuce', 'tomato', 'onion', 'cucumber']
  sauce?: string; // sauce item_id
  sauceCost?: number; // 0.50
  
  totalPrice: number; // calculated: base + upgrades + sauce
}
